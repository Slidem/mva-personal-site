...
const getProjectsFileContent = () => {
  const file = fs.readFileSync("src/app/projects/content.mdx", "utf-8");
  return file.toString();
};

export default function Projects() {
  const projectsContent = getProjectsFileContent();
  return (
    <>
      <Head>
      ...
      <div className="p-20 md:p-40 lg:p-64">
        ...
        <div className="relative">
          ...
          <MDXRemote
            source={projectsContent}
            components={projectsCustomComponents}
          />
        </div>
      </div>
    </>
