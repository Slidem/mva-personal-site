...
As a Senior Developer, I was instrumental in the development and scaling of a SaaS platform designed to streamline board communications for founders and investors.

## 🥇 Key Contributions and Achievements:

### Live Conferencing Tool with AI Integration: 
- Increased user prospects by creating a **live conferencing tool** with **WebRTC** and **WebSockets**, featuring live transcripts and third-party AI summaries, using React, React Query and NextJS
...
- **Cut down application load time by 50%** by optimizing APIs, refactoring front-end components, and implementing effective lazy loading strategies.
### Infrastructure and CI/CD Refactoring:
- **Increased deployment time by 50%** by refactoring and splitting up CDK stacks into fast and independently deployable stacks.
### Documentation, Best Practices, and Knowledge Sharing:
- Increased development velocity by authoring **well-structured documentation** on **coding best practices** and **architectural decisions**, while also conducting **regular knowledge-sharing sessions**
...
At Mambu, I was integral to the development and maintenance of the company's SaaS banking solutions, primarily on deployed AWS and later extended to be cross-compatible with Google Cloud. My main focus was on the IAM team, where I worked on a large monolithic Java application complemented by a suite of microservices on Kubernetes.
...
- Utilized PostgreSQL storage solutions, leveraging full-text search indexes and table partitioning for efficient data handling.
...
- Increased new user prospects by **designing and implementing a Data Loss Prevention (DLP) system POC**, demonstrating seamless integration with existing systems and tools.
...
As a Java Developer at UniCredit, I significantly contributed to two key projects. The first involved upgrading and adding new features to a large Trade Finance Java 1.4 and Java EE application, integrating front-end JSPs, back-end EJBs, and using SOAP for system communication. The second was developing a back-office application to automate financial cost calculations. Both projects involved extensive work with DB2 database integration and LDAP authentication.
